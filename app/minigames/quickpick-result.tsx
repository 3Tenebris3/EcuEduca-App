...
export default function QuickPickResult() {
  const { hits, misses } = useLocalSearchParams<{ hits: string; misses: string }>();
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: "bold", color: "#EF6C00", marginBottom: 12 },
  msg: { fontSize: 20, color: "#E65100", marginBottom: 24, textAlign: "center" },
  score: { fontSize: 18, color: "#5D4037", marginBottom: 32, textAlign: "center" },
  btn: {
